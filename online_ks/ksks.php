...
$query=mysql_query("select * from tb_user_grade where number='".$_SESSION['number']."' and suject='$subject'");
...
$grade="insert into tb_user_grade(grade,examsubject,datetime,number) values ('".$zf."','".$subject."','".$data."','".$_SESSION['number']."')";
if($grade_result=mysql_query($grade)){
	echo "<script>alert('完成考试');</script>";
}
}
?>
</body>
