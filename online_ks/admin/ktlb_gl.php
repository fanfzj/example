...
<table width="592" height="41" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#676767">
  ...
  <tr bgcolor="#EEEEEE">
    <td width="168" align="right"><span class="STYLE1">添加考题类</span></td>
    <td width="142"><input name="ktlb" type="text" id="online_ktlb" size="20" /></td>
...
<table width="594" height="49" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#676767">
 ...
 <td width="158" align="center" class="STYLE1">类别标识</td>
  ...
  ?>
  <tr bgcolor="#FFFFFF">
    <td align="center" class="STYLE1"><?php echo $myrow['Id']?></td>
    <td align="center" class="STYLE1"><?php echo $myrow['ktlb'];?></td>
    <td align="center" class="STYLE1"><a href="ktlb_gl_ok.php?delete_ktlb=<?php echo $myrow['Id']?>">删除</a></td>
  </tr>
  <?php }?>
</table>
</body>
